...
?>
    ...
    <div class="banner_content">
        ...
        <section id="nomination" class="nomination">
            ...
            <img src="http://localhost:8888/Koukaki/wp-content/uploads/2025/01/Rectangle-23.png" alt="fond du titre des nominations">
            <h3>Fleurs d’oranger & chats errants est nominé aux Oscars Short Film Animated de 2022 !</h3>
            </div>
            <img class="nomination__logo" src="http://localhost:8888/Koukaki/wp-content/uploads/2025/01/18-courts-metrages-francais-d-animation-eligibles-aux-oscars-2021-2.png" alt="Nomination aux Oscars 2022" "="">
        </section>
    </main><!-- #main -->
